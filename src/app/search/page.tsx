                        ...
                        <div className="text-gray-800 dark:text-gray-200 whitespace-pre-wrap leading-relaxed">
                          {assistantText ? (
                            ...
                            <div className="space-y-3 animate-pulse">
                              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full w-full opacity-80"></div>
                              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full w-11/12 opacity-60"></div>
                              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full w-10/12 opacity-40"></div>
                              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full w-full opacity-20"></div>
                              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-full w-9/12 opacity-10"></div>
                            </div>
                          ) : null}
                        </div>
                      </div>
